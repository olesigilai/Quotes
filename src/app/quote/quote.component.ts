...
export class QuoteComponent implements OnInit {
  ...
  Quotes: Quote[] = [
    new Quote(0, "Life is not a straight line, treat everyone equally.", "Akoko", "Gideon", new Date(2021, 1, 2), 0, 0),
    new Quote(1, "Live a life of your own, never trust other people's ways.", "Balotelli", "Kiplagat", new Date(2021, 1, 2), 0, 0),
